$localDir="F:\Programming\PersonalWebsite"
$localBackup="F:\Programming\tmp\website_backup.tar.gz"
$serverUser="ubuntu"
$serverHost="138.68.241.190"
$serverPEM="F:\Programming\Server Connection Files\DigitalOcean.pem"
